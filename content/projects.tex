...
\begin{cventry}
    ...
    \begin{cvitems}
        ...
        \item Receives \textm{\~{}600,000 weekly downloads} and used by \href{https://github.com/gajus/eslint-plugin-jsdoc}{eslint-plugin-jsdoc} and the \href{https://adonisjs.com}{AdonisJS web framework}.
    \end{cvitems}
\end{cventry}
